...
const baseyniSpaCopy = {
  ...
  services: [
    ...
    {
      icon: "RulerIcon",
      title: { bg: "Проектиране и дизайн", en: "Planning & Design" },
      description: {
        bg: "Индивидуални проекти, съобразени с визията и нуждите на обекта.",
        en: "Individual designs tailored to the vision and needs of the site.",
      },
    },
    {
      icon: "WrenchIcon",
